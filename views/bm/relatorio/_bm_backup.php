...
<table border="1" align="center" width="100%" style="margin-top: 1em">
	...
	<tr>
		...
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= number_format($escopos['executado_ee'] * $tipo_exec[4]['valor_hora'], 2, ',', '.') ?></td>
	</tr>	
	<?php $item++; } ?>
	<?php if(!empty($escopos['executado_es'])){ ?>
	<tr>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >0<?= $item ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >Mão de Obra (ES-AUT)</td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >Hh</td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= str_replace('.',',',sprintf("%.2f",$escopos['executado_es'])) ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?=str_replace('.',',',sprintf("%.2f",$tipo_exec[3]['valor_hora'])) ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= number_format($escopos['executado_es'] * $tipo_exec[3]['valor_hora'], 2, ',', '.') ?></td>
	</tr>	
	<?php $item++; } ?>	
	<?php if(!empty($escopos['executado_ep'])){ ?>
	<tr>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >0<?= $item ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >Mão de Obra (EP-AUT)</td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >Hh</td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= str_replace('.',',',sprintf("%.2f",$escopos['executado_ep'])) ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= str_replace('.',',',sprintf("%.2f",$tipo_exec[2]['valor_hora'])) ?></td>
		<td style="margin-top: 1.5em;font-size: 10pt;font-family: arial;"  ><?= number_format($escopos['executado_ep'] * $tipo_exec[2]['valor_hora'], 2, ',', '.') ?></td>
	</tr>	
	<?php $item++; } ?>
	<?php if(!empty($escopos['executado_ej'])){ ?>
	<tr>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >0<?= $item ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >Mão de Obra (EJ-AUT)</td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >Hh</td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= str_replace('.',',',sprintf("%.2f",$escopos['executado_ej'])) ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= str_replace('.',',',sprintf("%.2f",$tipo_exec[1]['valor_hora'])) ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= number_format($escopos['executado_ej'] * $tipo_exec[1]['valor_hora'], 2, ',', '.') ?></td>
	</tr>	
	<?php $item++; } ?>
	<?php if(!empty($escopos['executado_tp'])){ ?>
	<tr>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >0<?= $item ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >Mão de Obra (TP-AUT)</td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  >Hh</td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= str_replace('.',',',sprintf("%.2f",$escopos['executado_tp'])) ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= str_replace('.',',',sprintf("%.2f",$tipo_exec[0]['valor_hora'])) ?></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= number_format($escopos['executado_tp'] * $tipo_exec[0]['valor_hora'], 2, ',', '.') ?></td>
	</tr>	
	<?php $item++; } ?>
	...
	<tr>
		...
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= number_format($projeto->vl_km, 2, ',', '.') ?></td>
	...
	<tr>
		...
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ></td>
		<td style="margin-top: 0.5em;font-size: 10pt;font-family: arial;"  ><?= number_format($escopos['executado_ee'] * $tipo_exec[4]['valor_hora']+
																			$escopos['executado_es'] * $tipo_exec[3]['valor_hora'] +
																			$escopos['executado_ep'] * $tipo_exec[2]['valor_hora']+
																			$escopos['executado_ej'] * $tipo_exec[1]['valor_hora']+
																			$escopos['executado_tp'] * $tipo_exec[0]['valor_hora']+
