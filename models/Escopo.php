...
class Escopo extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['item', 'horas_tp',  'exe_tp_id', 'exe_ej_id', 'exe_ep_id', 'exe_ee_id', 'qtd', 'projeto_id', 'atividademodelo_id', 'status', 'executado', 'horas_tp', 'horas_ej', 'horas_ep', 'horas_es', 'horas_ee'], 'integer'],
            [['criado', 'modificado'], 'safe'],
            [['nome', 'for'], 'string', 'max' => 255],
            [['descricao'], 'string', 'max' => 160],
            [['horas_acumulada', 'horas_bm', 'horas_saldo','horas_tp_bm', 'horas_ej_bm', 'horas_ep_bm', 'horas_es_bm', 'horas_ee_bm', 'executado_tp','executado_ej','executado_ep','executado_es','executado_ee'], 'number'],
        ];
    }
